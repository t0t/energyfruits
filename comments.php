<aside class="Comments">
  ...
  <?php if ( have_comments() ) : ?>
  	<h4 class="Comments__title"><?php comments_number(' ', 'Hay un comentario', 'Hay % comentarios' );?></h2>
  ...
  <div class="Comments__respond">
  	<h4 class="Comments__title"><?php comment_form_title( '¿Deseas comentar algo?', 'Leave a Reply to %s' ); ?></h2>
  	...
  	<form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
  		...
  		<div>
  			<input class="btn btn--image" name="submit" type="submit" id="submit" tabindex="5" value="Publicar" />
